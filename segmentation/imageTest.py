...
if __name__ == '__main__':
    ...
    # 模型配置路径
    config_file = "/home/guest01/projects/chromos/segmentation/mmdetection/configs/chromos/my_mask_rcnn_r50_2x.py"
    # 训练好的模型参数
    # checkpoint_file = "/home/guest01/projects/chromos/segmentation/mmdetection/work_dirs/fake_overlap_500chromos/latest.pth"
    # init a detector
