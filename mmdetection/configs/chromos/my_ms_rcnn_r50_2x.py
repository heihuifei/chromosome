...
_base_ = '../ms_rcnn/ms_rcnn_r50_caffe_fpn_2x_coco.py'
...
data = dict(
    train=dict(
        img_prefix='/home/guest01/projects/chromos/dataset/segmentation_dataset/chromosome_coco_format/chromos/train_origin_77and187_overlap_1000',
        classes=classes,
        ann_file='/home/guest01/projects/chromos/dataset/segmentation_dataset/chromosome_coco_format/chromos/annotations/instances_train_origin77and187images_overlap1000images.json'),
    val=dict(
