...
class RRPNHead(AnchorHead):
    # Merge OrientedRPNHead and RotatedRPNHead
    """RRPN head for rotated bboxes.
    Args:
    ...
    def loss(self,
        ...
        return dict(loss_rrpn_cls=losses_cls, loss_rrpn_bbox=losses_bbox)
