...
class MaskScoringCountRoIHead(StandardRoIHead):
    """Mask Scoring RoIHead for Mask Scoring RCNN.

    https://arxiv.org/abs/1903.00241
    """

    def __init__(self, mask_iou_head, count_head, **kwargs):
        assert mask_iou_head is not None
        assert count_head is not None
        super(MaskScoringCountRoIHead, self).__init__(**kwargs)
        self.mask_iou_head = build_head(mask_iou_head)
        self.with_count = True if count_head is not None else False
    ...
    def _mask_forward_train(self, x, sampling_results, bbox_feats, gt_masks,
        ...
        mask_results = super(MaskScoringCountRoIHead,
