...
class ConvFCRBBoxHead(RBBoxHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(ConvFCRBBoxHead, self).__init__(
...
@HEADS.register_module()
class Shared2FCRBBoxHead(ConvFCRBBoxHead):
    """Shared2FC RBBox head."""

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared2FCRBBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
...
@HEADS.register_module()
class KFIoUShared2FCRBBoxHead(ConvFCRBBoxHead):
    """KFIoU RoI head."""

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(KFIoUShared2FCRBBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
