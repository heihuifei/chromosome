...
from mmdet.core import build_bbox_coder, multi_apply, multiclass_nms_rotated
...
class RBBoxHead(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(RBBoxHead, self).__init__(init_cfg)
    ...
    def loss(self,
        ...
        if cls_score is not None:
            ...
            if cls_score.numel() > 0:
                ...
                if isinstance(loss_cls_, dict):
                    ...
                    losses['loss_rbbox_cls'] = loss_cls_
        ...
        if bbox_pred is not None:
            ...
            if pos_inds.any():
                ...
                losses['loss_rbbox'] = self.loss_bbox(
                    pos_bbox_pred,
                ...
                losses['loss_rbbox'] = bbox_pred[pos_inds].sum()
        return losses
